    ...
    merchant.update(find_query, update_query, function (err, result) {
        if(err){
            ...
            merchant.find(find_query, function(err, doc){
               ...
               cur_rating /= doc[0].rate_user_number + 1;
               var rate_update_query = {$set : {rate_user_number : doc[0].rate_user_number + 1, cur_rating:cur_rating}};
               merchant.update(find_query, rate_update_query,function (err, doc) {
